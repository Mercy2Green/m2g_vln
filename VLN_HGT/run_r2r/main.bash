...
flag1="--exp_name release_r2r
      ...
      MODEL.pretrained_path pretrained/ETP/hgt_mlm.sap_r2r/model_step_5000.pt
      "
...
case $mode in 
      ...
      taskset -c 81-116 python -m torch.distributed.launch --nproc_per_node=2 --master_port $2 run.py $flag1
