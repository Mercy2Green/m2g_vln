...
def get_vlnbert_models(config=None):
    ...
    vis_config.GNN_conv_name = 'hgt'
    vis_config.GNN_n_hid = 768
    vis_config.GNN_n_heads = 12
    vis_config.GNN_n_layers = 1
    vis_config.GNN_dropout = 0.2
    vis_config.GNN_num_types = 2
    vis_config.num_relations = 2
    # load from pretrain finished model
