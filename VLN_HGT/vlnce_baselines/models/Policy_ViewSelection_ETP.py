...
class ETP(Net):
    ...
    def forward(self, mode=None, 
                ...
                obj_pos_fts = None, obj_clip_fts = None, 
                room_fts = None, room_pos = None, assigned_room_idxs = None, room_lens = None,
                graph_info = None, batch_hsg_lens = None, batch_graph_info_dict = None,):
