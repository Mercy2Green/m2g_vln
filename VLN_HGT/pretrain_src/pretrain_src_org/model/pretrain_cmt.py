...
class GlocalTextPathCMTPreTraining(BertPreTrainedModel):
    ...
    def forward(self, batch, task, compute_loss=True):
        ...
        if task.startswith('mlm'):
            return self.forward_mlm(
                ...
                batch['txt_labels'], batch['HGmap'], compute_loss
            )
            ...
            return self.forward_sap(
                ...
                batch['global_act_labels'], batch['local_act_labels'], batch['HGmap'], compute_loss
            )
    ...
    def forward_mlm(
        ...
        txt_labels, HGmaps_info, compute_loss
    ):
    ...
    def forward_sap(
        ...
        traj_step_lens, traj_vp_view_lens, traj_vp_obj_lens, traj_vpids, traj_cand_vpids,
        gmap_lens, gmap_step_ids, gmap_pos_fts, gmap_pair_dists, gmap_vpids,
        gmap_visited_masks, global_act_labels, local_act_labels, HGmap_info, compute_loss
    ):
