...
def foresee_images(proc_id, out_queue, scanvp_list, args):
    ...
    for scan_id, viewpoint_id in scanvp_list:
        ...
        for ix in range(VIEWPOINT_SIZE):
            ...
            # save at output_dir
            image.save(args.output_dir+"{scan_id}_{viewpoint_id}_{ix}.png".format(scan_id=scan_id, viewpoint_id=viewpoint_id, ix=ix))
...
def build_foresee_image_batch(args): # main funcution
